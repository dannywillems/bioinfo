...
public class SequencePairSameTest
{
    ...
    @Test
    public void rebuildWithGapsBeginTest()
    {
        Sequence initial = new Sequence("cgatctg");
        Sequence s = new Sequence("--cgat-c-tg");
        Sequence t = new Sequence("c-gat--ctg");
    ...
    @Test
    public void rebuildWithGapsBeginOrderDoesntChangeTest()
    {
        Sequence initial = new Sequence("cgatctg");
        Sequence s = new Sequence("--cgat-c-tg");
        Sequence t = new Sequence("c-gat--ctg");
    ...
    @Test
    public void rebuildWithGapsBeginBothTest()
    {
        Sequence initial = new Sequence("cgatctg");
        Sequence s = new Sequence("--cgat-c-tg");
        Sequence t = new Sequence("--c-gat--ctg");
    ...
    @Test
    public void rebuildWithGapsBeginBothOrderDoesntChangeTest()
    {
        Sequence initial = new Sequence("cgatctg");
        Sequence s = new Sequence("--cgat-c-tg");
        Sequence t = new Sequence("--c-gat--ctg");
